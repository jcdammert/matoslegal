export const content = {
  ...
  urgency: {
    ...
    sub: "Arrange your FREE phone consultation today.",
  ...
  practice: {
    ...
    headlineEnd: "Areas",
    subhead:
      "Comprehensive legal representation built on two decades of trial and appellate experience.",
    areas: [
      {
        num: "01",
        icon: "shield",
        title: "Foreclosure Defense",
        desc: "Protecting homeowners and property owners from foreclosure with strategic, experienced legal defense.",
        ...
        detail: {
          ...
          services: {
            heading: "Defenses We Raise in Foreclosure Cases",
            items: [
              "Lack of standing — challenging whether the lender actually holds the original note and mortgage",
              "Chain of title and assignment defects — improper or fraudulent mortgage assignments",
              "Misapplied and unposted payments — exposing false defaults created by servicer errors",
              "Dual tracking violations — lenders foreclosing while processing a loan modification application",
              "Zombie mortgage defenses — statute of limitations, lien abandonment, and chain-of-ownership challenges",
              "Failure to comply with conditions precedent — notice defects that can be a complete defense",
              "RESPA and TILA violations — federal violations giving homeowners powerful negotiating leverage",
              "Wrongful and unlawful foreclosure claims — affirmative actions to restore rights and recover damages",
            ],
          },
          approach: {
      ...
      },
      {
        ...
        desc: "Representing landlords and tenants in residential and commercial disputes throughout South Florida.",
        slug: "landlord-tenant",
        detail: {
          heroSub:
            "Experienced representation for landlords and tenants — residential and commercial.",
          intro:
            "Disputes between residential landlords and tenants are among the most common — and most consequential — real estate matters that Florida courts handle. Florida's Residential Landlord and Tenant Act (Chapter 83, Florida Statutes) governs the rights and responsibilities of both parties and sets out specific procedures that must be followed. We represent both landlords and tenants in residential and commercial disputes throughout South Florida.",
          body: [
            "For tenants, their home is not simply a legal matter — it is their family's stability and security. For a landlord, a rental property is a significant investment that must be protected. We bring equal dedication to both sides of the equation, whether the dispute involves residential housing or a complex commercial lease.",
            "Commercial landlord-tenant disputes require an even deeper level of knowledge. Commercial leases are heavily negotiated contracts — often running dozens of pages — with terms that can dramatically affect the rights and remedies available to each party. Unlike in residential tenancies, commercial tenants have far fewer statutory protections, making the lease itself the primary document governing both parties' rights.",
          ],
          services: {
            heading: "What We Can Help With",
            items: [
              "Wrongful eviction defense and unlawful lockout or utility shutoff claims",
              "Constructive eviction — when a landlord's neglect forces a tenant to vacate",
              "Security deposit disputes and wrongful withholding under Florida's strict statutes",
              "Habitability and warranty of fitness claims — holding landlords accountable",
              "Landlord retaliation claims for tenants who exercise their legal rights",
              "Eviction proceedings for nonpayment, lease violations, and holdover tenants",
              "CAM charge and operating expense disputes in commercial leases",
              "Lease assignment, subletting, renewal option, and co-tenancy disputes",
              "Enforcement of commercial lease covenants and exclusivity provisions",
              "Lease drafting and review for residential and commercial landlords",
            ],
          },
          approach: {
            eyebrow: "— OUR APPROACH",
      ...
      },
      {
        ...
        desc: "Buyer-seller disputes, quiet title actions, and escrow conflicts in South Florida's competitive market.",
        slug: "real-estate-disputes",
        detail: {
          heroSub:
            "Protecting buyers, sellers, and property owners in South Florida's high-stakes real estate market.",
          intro:
            "In South Florida's competitive real estate market, transactions can move at a breathtaking pace — and when something goes wrong, the financial consequences can be devastating. Whether you are a buyer who has lost a deposit, a seller accused of concealing a defect, or a property owner whose title has been clouded by a competing claim, we have the experience and tenacity to protect your interests.",
          body: [
            "Real estate purchase and sale disputes in Florida are governed primarily by the contract itself, together with Florida's disclosure requirements and general contract law. We have handled disputes involving the standard FAR/BAR and AS-IS contracts used throughout Florida, as well as custom purchase agreements in commercial and high-value residential transactions.",
            "We also handle quiet title actions — lawsuits asking the court to formally determine ownership of a property and eliminate all competing or adverse claims — arising from errors in the chain of title, fraudulent deeds, unresolved liens, adverse possession claims, and post-foreclosure title issues. Clear title is the foundation of every real estate transaction, and when it is clouded, we resolve it.",
          ],
          services: {
            heading: "What We Can Help With",
            items: [
              "Breach of purchase and sale agreement — buyers and sellers who fail to perform",
              "Escrow deposit disputes and interpleader proceedings",
              "Seller misrepresentation and non-disclosure of known material defects",
              "Specific performance — compelling a party to complete the transaction as agreed",
              "AS-IS contract disputes over inspection rights and termination claims",
              "New construction and developer disputes including pre-construction deposits",
              "Quiet title actions to clear clouds on title and establish undisputed ownership",
              "Chain of title errors, fraudulent deeds, and improper lien releases",
              "Post-closing disputes over undisclosed defects and title problems",
              "Escrow agent liability and claims for improper disbursement of funds",
            ],
          },
          approach: {
            eyebrow: "— OUR APPROACH",
      ...
      },
      {
        ...
        desc: "Strategic advocacy in breach of contract, business torts, and complex civil disputes.",
        ...
        detail: {
          ...
          services: {
            heading: "What We Can Help With",
            items: [
              "Breach of contract — business contracts, service agreements, and promissory notes",
              "Construction contract disputes and subcontractor claims",
              ...
              "Breach of fiduciary duty by officers, directors, partners, or managing members",
              "Civil theft and conversion — wrongful taking of property under Florida law",
      ...
      },
      {
        num: "05",
        icon: "briefcase",
        title: "Non-Compete & Business Disputes",
        desc: "Non-compete enforcement and defense, partnership disputes, and debt collection litigation.",
      ...
      },
      {
        ...
        detail: {
          ...
          services: {
            heading: "Cases We May Accept",
            items: [
              "Equal protection and due process violations arising from government action",
              "Section 1983 claims against state and local government officials",
              "First Amendment — freedom of speech, association, or petition",
              "Fourth Amendment — unlawful search and seizure",
              "Civil rights claims intersecting with real estate — discriminatory lending and eviction",
  ...
  why: {
    ...
    headlineStart: "Built On",
    headlineAccent: "Trust",
    headlineEnd: "And Experience",
    items: [
      {
        icon: "clock",
        title: "24+ Years of Experience",
        desc: "Attorney Rosalind J. Matos brings over two decades of legal experience in state and federal courts at both trial and appellate levels.",
      },
      {
        icon: "languages",
        title: "Bilingual Services",
        desc: "We proudly serve our English and Spanish-speaking community. Hablamos Español.",
      },
      {
        icon: "target",
        title: "Personalized Strategy",
        desc: "Every case is unique. We develop individualized legal strategies tailored to your specific needs and goals.",
      },
      {
        icon: "phone",
        title: "Free Phone Consultation",
        desc: "We offer a free initial phone consultation so you can understand your options before making any commitments.",
      },
    ],
  },
  testimonials: {
    eyebrow: "— CLIENT STORIES",
    headlineStart: "What Our",
  ...
  finalCta: {
    headlineStart: "Ready For A",
    headlineAccent: "Free",
    headlineEnd: "Consultation?",
    sub: "Speak directly with Attorney Rosalind J. Matos. No obligation, no pressure — just clear answers and honest guidance.",
  ...
  attorney: {
    ...
    subhead:
      "Two decades of trial and appellate experience in state and federal courts — fully bilingual, deeply committed.",
    bioEyebrow: "— BIOGRAPHY",
    photoName: "Rosalind J. Matos",
    photoRole: "FOUNDER / OWNER",
    photoEmail: "rosalind@matoslegal.com",
    bio: [
      "Rosalind J. Matos has 24 years of legal experience and has successfully represented clients in both state and federal courts at trial and appellate levels. Fully bilingual, she brings a strong background in civil litigation with a focus on real estate disputes including foreclosure defense, landlord-tenant matters, and buyer-seller conflicts.",
      "Her career began as South Florida Staff Counsel for the ACLU of Florida in Miami — nearly 8 years working on civil liberties issues including police misconduct, racial profiling, privacy rights, free speech, student rights, and religious freedom. At the ACLU she litigated federal civil rights cases, assessed legislation for constitutional concerns, testified before legislative committees, and collaborated with advocates. She served on the Miami-Dade Racial Profiling Advisory Board and lobbied for the Civilian Investigative Panel (CIP).",
      "She later joined Legal Aid Service of Broward County for foreclosure defense, helping low-income families save their homes through litigation and loan modification negotiations. She then took a leadership role at Glantz and Glantz managing the foreclosure department.",
      "She founded Matos Legal, PLLC in March 2014. With a background in hospitality management from FIU, the firm has been serving clients in the Tri-County area for over a decade with deep roots in the community, earning a reputation for trust, reliability, and legal excellence.",
    ],
    credentials: {
      bar: {
        ...
        items: [
          ...
          "U.S. District Courts for the Southern District of Florida (2001)",
          "U.S. District Courts for the Northern District of Florida (2001)",
      ...
      education: {
        ...
        items: [
          {
            school: "University of Puerto Rico School of Law",
            detail: "Juris Doctor · GPA 3.4 · cum laude · Top 15%",
          },
          {
            school: "Florida International University",
            detail: "B.S. Hospitality Management · GPA 3.65 · cum laude",
          },
        ],
      },
      memberships: {
        title: "Memberships",
        items: ["Broward Lawyers Care – Legal Aid Service of Broward County"],
      },
    },
  },
  contact: {
